/**
 * Phase 1: push the fixtures to a real GitHub pull request.
 *
 *   pnpm phase1:seed -- --dry-run     # print what would be posted, no network
 *   pnpm phase1:seed -- --push        # also git push main + the PR branch first
 *   pnpm phase1:seed                  # open/find the PR and post missing comments
 *
